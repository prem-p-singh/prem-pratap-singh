  ...
  return (
    <>
      ...
      <section id="publications" className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title mb-12">Selected Publications</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-foreground">
              20+ peer-reviewed publications in journals including Food Chemistry, Scientific Reports, and Food Control.
            </p>
          </div>
        </div>
      </section>

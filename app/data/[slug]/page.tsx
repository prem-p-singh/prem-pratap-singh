    ...
    <article className="pt-16">
      ...
      <section className="pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Dataset provenance and reproducibility details */}
          <div className="mt-8 grid gap-4 rounded-xl border border-border bg-card p-5 text-sm sm:grid-cols-2">
            {post.dataset && (
              <div>
                <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-muted-foreground">Dataset</p>
            ...
            {post.codePath && (
              <div>
                <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-muted-foreground">Reproducible code</p>

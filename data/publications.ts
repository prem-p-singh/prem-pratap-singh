...
export const publications: Publication[] = [
  ...
  {
    title: "Essential oils as green promising alternatives to chemical preservatives for agri-food products: New insight into molecular mechanism, toxicity assessment, and safety profile",
  ...
  {
    title: "Insights into the antimicrobial efficacy of Coleus aromaticus essential oil against food-borne microbes: Biochemical and molecular simulation approaches",
  ...
  {
    title: "Synthesis, characterization, and assessment of chitosan-nanomatrix enriched with antifungal formulation against biodeterioration of herbal raw materials",
...
export const bookChapters: Publication[] = [
  {
    title: "Food and human health: An outlook of the journey of food from hunger satisfaction to health-promoting agent",
    authors: ["B. Prakash", "P. P. Singh", "A. Kumar", "V. Gupta"],
  ...
  },
  {
    ...
    venue: "PGPR Amelioration in Sustainable Agriculture",
    year: 2019,
    type: "book",
    links: {
      paper: "#",
...
export const thesis = {
  title: "Assessment and amelioration of plant-based bioactive formulation against food-borne pathogens",

...
tldr:
  - "A pathogen long non-coding RNA secreted into rice sequesters a host miRNA, acting as a regulatory decoy."
  - "Virulence factors should be defined by function, not by whether they encode proteins."
  - "Plant disease multi-omics should be designed to capture small RNAs and long non-coding RNAs from the start."
  - "If RNA-mediated virulence is real, RNA-based protection through stable delivery becomes a credible management direction."
---
...
![How plant pathogens use RNA to cause disease](/blog/pathogen-rnas-are-crossing-kingdoms-and-plant-disease-research-needs-to-catch-up/rna-virulence.jpg)

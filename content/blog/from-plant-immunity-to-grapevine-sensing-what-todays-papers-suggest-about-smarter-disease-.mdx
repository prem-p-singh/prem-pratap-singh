...
tldr:
  - "Disease management improves when host response, pathogen ecology, and plant structure are studied together."
  - "New plant immunity, residue microbiome, and grapevine imaging work each push toward this integrated frame."
  - "Grapevine virus systems are rarely explained by any single layer alone."
---

...
tldr:
  - "New work on 3D point-cloud extraction and pruning-point detection makes vine architecture machine-readable."
  - "Better structural data supports rigorous comparison of healthy and stressed vines under chronic infection."
  - "Architecture, stress physiology, and pathogen biology should be measured as one framework."
  - "Precision pruning and targeted delivery both depend on the structural mapping that is now within reach."
---
...
![From vine geometry to disease insight: 3D grapevine modeling](/blog/from-vine-geometry-to-disease-insight-why-3d-grapevine-modeling-caught-my-attention-today/vine-geometry-3d.png)

...
tldr:
  - "Crop residues act as ecotones where pathogens persist between seasons, not as inert waste."
  - "Cross-omics integration can turn messy, incomplete datasets into earlier disease signals before visible symptoms."
  - "Pairing residue ecology with multi-omics modeling is a realistic route to better forecasting and management."
---

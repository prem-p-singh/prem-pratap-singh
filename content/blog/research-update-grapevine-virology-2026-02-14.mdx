...
- [Grapevine red blotch virus — ViralZone](https://viralzone.expasy.org/6590)
- [Multi-omics approaches for understanding plant-virus interactions — Frontiers in Plant Science](https://www.frontiersin.org/journals/plant-science)
- [Chitosan nanoparticles in agriculture — Carbohydrate Polymers](https://www.sciencedirect.com/journal/carbohydrate-polymers)
- [DESeq2 — Bioconductor differential expression analysis](https://bioconductor.org/packages/release/bioc/html/DESeq2.html)
- [GRBV impacts on berry development — American Journal of Enology and Viticulture](https://www.ajevonline.org/)

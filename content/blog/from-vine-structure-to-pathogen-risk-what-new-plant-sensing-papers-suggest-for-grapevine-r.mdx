...
tldr:
  - "Three recent papers extract vine structure from images and point clouds with practical precision."
  - "A molecular biomarker for plant water status helps separate stress effects from pathogen effects."
  - "Pathogen success is shaped by spatial scale and by microbial life in crop residues, not host alone."
  - "Connecting architecture, physiology, and pathogen pressure into one measurable system is the right frame."
---

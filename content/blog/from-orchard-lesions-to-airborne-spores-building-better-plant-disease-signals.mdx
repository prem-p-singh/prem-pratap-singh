...
![Five plant disease measurement signals (leaf image segmentation, airborne fungal spores, soil and leaf microbiome, DNA metabarcoding, and high-throughput crop phenotyping) converging into an early disease decision, while preserving each signal's biological meaning before combining](/blog/from-orchard-lesions-to-airborne-spores-building-better-plant-disease-signals/disease-signals-infographic.jpg)

...
tldr:
  - "Plant pathology is moving from 'what changes' to 'where in the tissue and in which cells'."
  - "Spatial omics and single-cell four-omics make defenses and pathogen pressures locatable within tissues."
  - "For grapevine virology, spatial resolution helps explain symptom heterogeneity across tissues and seasons."
---
...
- [Gene regulatory field dissected by single-cell four-omics sequencing - Nature](https://news.google.com/rss/articles/CBMiX0FVX3lxTE5lbzF1b19WV08tdElsSU1oWXFLS09FWkVrNlVTYkExbjVuMTdBdlVJZ0Q4TlA2TGpsSHVLX0FaV3BVenJvSDZSdEU3SVZUNXNQWDhMb3ItTGVWRVNOTEhB?oc=5)

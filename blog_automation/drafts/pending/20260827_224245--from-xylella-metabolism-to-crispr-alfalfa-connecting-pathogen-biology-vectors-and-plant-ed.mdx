...
What I take from this is that plant protection needs connected evidence across scales. For *Xylella*, a conserved metabolic prediction becomes more informative when paired with woody-host biology, vector anatomy, and seasonal transmission models. Each component addresses a different constraint: what the bacterium may require, where it persists, how an insect feeds, and when transmission may occur.

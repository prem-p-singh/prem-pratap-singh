export const personal = {
  ...
  openTo: "Open to Research Scientist and Data Scientist roles in ag-bio R&D, molecular diagnostics, NGS workflows, and trait discovery.",
